...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_©Bais Botz*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/bais.07')
}
if(isButton == 'ytm'){
reply('http://youtube.com/')
}
   ...
   const sotoy = [
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        if (!isStcSticker) return reply('Tag / Reply Stickernya !!')
...
//// PEMBATAS MENU STORAGE\\\
 ...
 footerText: 'Bais Botz✓',
 description: `Hai kak☺️ Silahkan pilih menu asupan disini,Gunakan Dengan Bijak Ya kak`,
 sections: [
                     {
...
break    
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
    ...
    case 'playstore':
    if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
            if(!c) return reply('Mau cari apa?')
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    "hydratedContentText": `Hi ${pushname} 👋,\n\n${jmn} - ${week} ${weton} - ${calender}`,
    "hydratedFooterText": `Bais Botz Whatsapp`,
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Bais Botz Whatsapp`,
...
const btngrass = {
    contentText: `${anu}`,
    footerText: '*_©Bais Botz WhatsApp_*',
    buttons: punten,
    headerType: 1
}
